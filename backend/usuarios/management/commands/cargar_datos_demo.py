...
class Command(BaseCommand):
    ...
    {"nombre": "Región de Ñuble", "ciudades": [{"nombre": "Chillán", "comunas": ["Chillán", "Chillán Viejo", "Bulnes", "Quillón", "Yungay", "El Carmen", "San Ignacio", "Pinto", "Coihueco", "San Carlos", "Ninhue", "San Fabián", "Trehuaco", "Quirihue", "Cobquecura", "Portezuelo", "Ránquil"]}]},
    {"nombre": "Región del Biobío", "ciudades": [{"nombre": "Concepción", "comunas": ["Concepción", "Talcahuano", "San Pedro de la Paz", "Chiguayante", "Hualpén", "Coronel", "Lota", "Penco", "Tomé", "Florida", "Hualqui", "Santa Juana"]}, {"nombre": "Los Ángeles", "comunas": ["Los Ángeles", "Nacimiento", "Laja", "San Rosendo", "Santa Bárbara", "Quilleco", "Tucapel", "Antuco", "Mulchén"]}, {"nombre": "Arauco", "comunas": ["Curanilahue", "Cañete", "Contulmo", "Tirúa", "Arauco", "Lebu"]}]},
    {"nombre": "Región de La Araucanía", "ciudades": [{"nombre": "Temuco", "comunas": ["Temuco", "Padre Las Casas", "Nueva Imperial", "Carahue", "Cholchol", "Cunco", "Curarrehue", "Freire", "Gorbea", "Lautaro", "Loncoche", "Melipeuco", "Perquenco", "Pitrufquén", "Pucón", "Saavedra", "Teodoro Schmidt", "Toltén", "Vilcún", "Villarrica"]}, {"nombre": "Angol", "comunas": ["Angol", "Collipulli", "Curacautín", "Ercilla", "Lonquimay", "Los Sauces", "Lumaco", "Purén", "Renaico", "Traiguén", "Victoria"]}]},
    ...
    {"nombre": "Región de Magallanes y de la Antártica Chilena", "ciudades": [{"nombre": "Punta Arenas", "comunas": ["Punta Arenas", "Río Verde", "Laguna Blanca", "San Gregorio"]}, {"nombre": "Puerto Natales", "comunas": ["Natales", "Torres del Paine"]}, {"nombre": "Porvenir", "comunas": ["Porvenir", "Primavera", "Timaukel"]}, {"nombre": "Antártica", "comunas": ["Antártica"]}]}
        ...
        for nombre in servicio_nombres:
            ...
            #s.trabajadores.set(random.sample(Trabajador, k=random.randint(5, 10)))
            servicios.append(s)
